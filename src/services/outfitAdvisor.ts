...
export function calculateOutfit(
  ...
  if (temperature === null || isNaN(temperature)) {
    return {
      activity,
      temperature: null,
      perceivedEffortTemp: null,
      isRaining,
      isAllergyMode,
      summaryRule: 'Temperatura en tiempo real no disponible. Viste por capas.',
      overallAdvice:
        'Sin telemetría de temperatura en el sensor de la zona. Se recomienda técnica de tres capas ajustables (capa base transpirable, capa térmica ligera y cortavientos desmontable).',
      garments: [
        {
          id: 'versatile-base',
          category: 'torso',
          categoryLabel: 'Torso',
          name: 'Camiseta técnica de manga corta transpirable',
          description: 'Capa base polivalente para mantener el torso seco.',
          iconName: 'Shirt',
          isCrucial: true,
        },
        {
          id: 'versatile-layer',
          category: 'torso',
          categoryLabel: 'Segunda Capa',
          name: 'Cortavientos ultraligero desmontable',
          description: 'Prenda ligera que puedes atar a la cintura si la temperatura es agradable.',
          iconName: 'Wind',
          isCrucial: true,
        },
        {
          ...
          name: isRunning ? 'Pantalón corto o mallas pirata' : 'Pantalón deportivo elástico',
          description: 'Apto para un rango térmico amplio de 12°C a 22°C.',
          iconName: 'Layers',
          isCrucial: true,
        },
      ],
      healthTips: [
        'Comprueba las sensaciones térmicas durante los primeros 10 minutos de calentamiento.',
      ],
    };
  }
  ...
  if (!isRunning) {
    ...
    if (temperature < 12 || isRaining) {
      ...
      garments.push({
        ...
        name: isRaining
          ? 'Cortavientos Impermeable (Waterproof)'
          : 'Chaqueta Abrigada / Plumífero Ligero',
      ...
      garments.push({
        ...
        name: isRaining
          ? 'Calzado cómodo impermeable / Gore-Tex'
          : 'Calzado cómodo con amortiguación',
        description: isRaining
      ...
      healthTips.push(
        'Al andar a paso ligero mantienes un gasto de ~250-350 kcal/h; no dejes las manos al descubierto si el viento supera los 20 km/h.'
      );
      healthTips.push(
        'En parques como El Retiro o Casa de Campo los caminos de tierra pueden encharcarse con lluvia.'
      );
    } else if (temperature >= 12 && temperature <= 20) {
      summaryRule = '12°C - 20°C: Sudadera ligera o chaqueta fina.';
      overallAdvice =
        'Temperatura ideal y templada para pasear por Madrid. Una segunda capa ligera que puedas quitarte o abrirte al sol es la combinación perfecta.';
      ...
      healthTips.push(
        'Aprovecha las horas centrales si buscas vitamina D o las sombras de plátanos de sombra en El Retiro si buscas frescor.'
      );
    } else {
      // > 20°C
      summaryRule = '> 20°C: Ropa fresca, gorra y protección solar.';
      overallAdvice =
        'Clima cálido. Evita tejidos sintéticos pesados o prendas oscuras que absorban radiación solar. Hidrátate con regularidad en fuentes municipales.';
      ...
      healthTips.push(
        'Bebe pequeños sorbos de agua cada 20 minutos; en Madrid hay más de 2.000 fuentes de agua potable en parques públicos.'
      );
    }
  } else {
    // 🏃‍♂️ CORRER (RUNNING)
    ...
    if (temperature < 10) {
      if (isRaining) {
        ...
        overallAdvice =
          'Condición fría y húmeda para correr. La clave técnica es no empaparse por fuera con la lluvia ni por dentro con tu propio sudor: membrana técnica con aberturas de ventilación.';
        ...
        garments.push({
          ...
          description:
            'Evacua el sudor rápidamente hacia la capa exterior sin retener humedad.',
          iconName: 'Shirt',
          isCrucial: true,
        });
        ...
        garments.push({
          ...
          description:
            'Repelen salpicaduras de agua y mantienen caliente la musculatura isquiotibial.',
          iconName: 'Layers',
          isCrucial: true,
        });
        ...
        garments.push({
          ...
          description:
            'Goma adherente para evitar resbalones en asfalto mojado o adoquines.',
          iconName: 'Footprints',
          isCrucial: true,
        });
        ...
        summaryRule =
          '< 10°C: Mallas largas, camiseta técnica manga larga y cortavientos ligero.';
        overallAdvice =
          'Frío matutino o invernal. Al empezar tendrás frío los primeros 10 minutos, pero a partir del km 2 tu cuerpo regulará a ~20°C equivalentes. No te sobreabrigues.';
        ...
        garments.push({
          ...
          description:
            'Bloquea el aire frío en bajadas o zonas abiertas; puedes atarlo a la cintura si entras en calor.',
          iconName: 'Wind',
          isCrucial: true,
        });
        ...
        garments.push({
          ...
          description:
            'Calcetines técnicos sintéticos (evita 100% algodón que produce ampollas con el frío).',
          iconName: 'Footprints',
          isCrucial: true,
        });
        ...
        garments.push({
          ...
          description:
            'Las extremidades son las primeras en enfriarse por vasoconstricción periférica.',
          iconName: 'Sparkles',
          isCrucial: false,
        });
      }
      ...
      healthTips.push(
        'Haz un calentamiento articular activo de 5 minutos antes de salir a la intemperie para prevenir lesiones musculares por frío.'
      );
    } else if (temperature >= 10 && temperature <= 18) {
      summaryRule = '10°C - 18°C: Camiseta técnica manga corta y pantalón corto.';
      overallAdvice =
        '¡La "Ventana de Oro" del corredor! Con el esfuerzo físico tu sensación térmica rondará los 20°C - 28°C, que es el rango más eficiente para rendimiento aeróbico.';
      ...
      garments.push({
        ...
        description:
          'Microfibra de secado ultra-rápido con costuras planas para evitar rozaduras.',
        iconName: 'Shirt',
        isCrucial: true,
      });
      ...
      garments.push({
        ...
        description:
          'Buen retorno de energía tanto en asfalto como en senderos de tierra compactada.',
        iconName: 'Footprints',
        isCrucial: true,
      });
      ...
      garments.push({
        ...
        description:
          'Altura tobillera o media con refuerzo en metatarso y talón de Aquiles.',
        iconName: 'Footprints',
        isCrucial: false,
      });
      ...
      healthTips.push(
        'Con esta temperatura la tasa de sudoración es controlada, pero bebe 150-250 ml de agua cada 5 km.'
      );
    } else {
      // > 18°C
      summaryRule = '> 18°C: Camiseta técnica ligera/tirantes y visera.';
      overallAdvice =
        'Temperatura cálida a calurosa. Tu sensación térmica superará los 28°C - 35°C con el esfuerzo. Máxima prioridad en disipación de calor, ventilación y protección contra el sol.';
      ...
      garments.push({
        ...
        description:
          'Malla perforada o tejido ultraligero (< 70g) que maximice la evaporación del sudor.',
        iconName: 'Sun',
        isCrucial: true,
      });
      ...
      garments.push({
        ...
        description:
          'La visera deja abierta la coronilla permitiendo que el calor escape de la cabeza, a la vez que frena el sudor de la frente.',
        iconName: 'Sparkles',
        isCrucial: true,
      });
      ...
      garments.push({
        ...
        name: 'Soft Flask con electrolitos',
        description:
          'En Madrid el ambiente seco acelera la pérdida de sales minerales como sodio y potasio.',
        iconName: 'Activity',
        isCrucial: true,
      });
      ...
      garments.push({
        ...
        description:
          'Facilita la expulsión de aire caliente del interior de la zapatilla evitando recalentamiento.',
        iconName: 'Footprints',
        isCrucial: true,
      });

      healthTips.push(
        'Evita rodajes a ritmos máximos entre las 12:00 y las 19:00 en días soleados de primavera/verano.'
      );
      healthTips.push(
        'La Casa de Campo y El Retiro ofrecen sombras continuas que bajan hasta 3°C la temperatura ambiente respecto a calles de asfalto.'
      );
    }
  }
  ...
  if (isAllergyMode) {
    garments.push({
      ...
      description:
        'Bloquean el impacto directo de granos de polen sobre la conjuntiva ocular reduciendo lagrimeo y picor.',
      iconName: 'Glasses',
      isCrucial: true,
    });
    ...
    garments.push({
      ...
      description:
        'Evita que los granos de polen queden atrapados en el pelo durante el entrenamiento.',
      iconName: 'Sparkles',
      isCrucial: true,
    });

    healthTips.push(
      '🌸 Modo Alergia: Dúchate y lávate el pelo inmediatamente al regresar a casa para no inhalar el polen depositado.'
    );
    healthTips.push(
      '🌸 Realiza lavados nasales con solución salina isotónica para despejar partículas antes y después del ejercicio.'
    );
    healthTips.push(
      '🌸 Evita las horas de máxima emisión polínica (19:00 a 22:00 h cuando el aire se enfría y desciende).'
    );
  }
